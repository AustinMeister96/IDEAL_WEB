# Generated by Django 4.2.1 on 2023-08-24 17:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("statins", models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reciva_collection_date",
                    models.DateTimeField(
                        null=True, verbose_name="reciva collection date"
                    ),
                ),
                ("reciva_time_since_collection", models.IntegerField(default=0)),
                (
                    "reciva_collection_site",
                    models.CharField(
                        choices=[
                ...
                (
                    "reciva_ship_date",
                    models.DateTimeField(null=True, verbose_name="reciva ship date"),
                ),
                (
                    "reciva_received_date",
                    models.DateTimeField(
                        null=True, verbose_name="reciva received date"
                    ),
                ),
                ("reciva_shipping_method", models.CharField(max_length=200)),
                ("reciva_sample_stored", models.BooleanField(default=False)),
                (
                    "reciva_sample_storage_date",
                    models.DateTimeField(
                        null=True, verbose_name="reciva sample storage date"
                    ),
                ),
                ...
                (
                    "reciva_istd_applied",
                    models.CharField(
                        choices=[("Maual", "Manual"), ("CSLR", "CSLR")],
                        max_length=200,
                        null=True,
                    ),
                ),
                ...
                (
                    "reciva_sample_run_date",
                    models.DateTimeField(
                        null=True, verbose_name="reciva sample run date"
                    ),
                ),
                (
                    "reciva_sample_run_instrument",
                    models.CharField(
                        choices=[
                ...
                (
                    "room_air_collection_date",
                    models.DateTimeField(
                        null=True, verbose_name="room air collection date"
                    ),
                ),
                ("room_air_time_since_collection", models.IntegerField(default=0)),
                (
                    "room_air_collection_site",
                    models.CharField(
                        choices=[
                            ("British Columbia", "British Columbia"),
                            ("Ontario", "Ontario"),
                ...
                (
                    "room_air_ship_date",
                    models.DateTimeField(null=True, verbose_name="room air ship date"),
                ),
                (
                    "room_air_received_date",
                    models.DateTimeField(
                        null=True, verbose_name="room air received date"
                    ),
                ),
                ("room_air_shipping_method", models.CharField(max_length=200)),
                ("room_air_sample_stored", models.BooleanField(default=False)),
                (
                    "room_air_sample_storage_date",
                    models.DateTimeField(
                        null=True, verbose_name="room air sample storage date"
                    ),
                ),
                ...
                (
                    "room_air_sample_run_date",
                    models.DateTimeField(
                        null=True, verbose_name="room air sample run date"
                    ),
                ),
                (
                    "room_air_sample_run_instrument",
                    models.CharField(
                        choices=[
                            ("Orbitrap 736", "Orbitrap 736"),
                            ("Bench TOF", "Bench TOF"),
                ...
                (
                    "room_air_sample_visual_inspection",
                ...
                (
                    "casper_collection_date",
                    models.DateTimeField(
                        null=True, verbose_name="casper collection date"
                    ),
                ),
                ("casper_time_since_collection", models.IntegerField(default=0)),
                (
                    "casper_collection_site",
                    models.CharField(
                        choices=[
                            ("British Columbia", "British Columbia"),
                            ("Ontario", "Ontario"),
                ...
                (
                    "casper_ship_date",
                    models.DateTimeField(null=True, verbose_name="casper ship date"),
                ),
                (
                    "casper_received_date",
                    models.DateTimeField(
                        null=True, verbose_name="casper received date"
                    ),
                ),
                ("casper_shipping_method", models.CharField(max_length=200)),
                ("casper_sample_stored", models.BooleanField(default=False)),
                (
                    "casper_sample_storage_date",
                    models.DateTimeField(
                        null=True, verbose_name="casper sample storage date"
                    ),
                ),
                ...
                (
                    "casper_sample_run_date",
                    models.DateTimeField(
                        null=True, verbose_name="casper sample run date"
                    ),
                ),
                (
                    "casper_sample_run_instrument",
                    models.CharField(
                        choices=[
                            ("Orbitrap 736", "Orbitrap 736"),
                            ("Bench TOF", "Bench TOF"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("inclusion_criteria_1", models.BooleanField(default=False)),
                ("inclusion_criteria_2", models.BooleanField(default=False)),
                ("inclusion_criteria_3", models.BooleanField(default=False)),
                ("inclusion_criteria_4", models.BooleanField(default=False)),
                ("inclusion_criteria_5", models.BooleanField(default=False)),
                ("inclusion_criteria_6", models.BooleanField(default=False)),
                ("inclusion_criteria_7", models.BooleanField(default=False)),
                ("inclusion_criteria_8", models.BooleanField(default=False)),
                ("inclusion_criteria_9", models.BooleanField(default=False)),
                ("inclusion_criteria_9_a", models.BooleanField(default=False)),
                ("inclusion_criteria_9_b", models.BooleanField(default=False)),
                ("inclusion_criteria_9_c", models.BooleanField(default=False)),
                ("inclusion_criteria_9_d", models.BooleanField(default=False)),
                (
                    "inclusion_status",
                    models.TextField(
                        choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("cooking", models.TextField(blank=True, max_length=20, null=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("nodule_rank", models.TextField(max_length=20)),
                ...
                (
                    "nodule_technition_accepted",
                    models.TextField(
                        choices=[("deleted", "Deleted"), ("added", "Added")],
                        default=None,
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("cat_5_comments", models.TextField(blank=True, max_length=20)),
                (
                ...
                (
                    "airways_type",
                    models.ManyToManyField(blank=True, to="DataEntry.airways_type"),
                ),
                (
                    "cat_5_findings",
                    models.ManyToManyField(blank=True, to="DataEntry.cat_5_findings"),
                ),
                (
                    "copd_emphysema_type",
                    models.ManyToManyField(blank=True, to="DataEntry.emphysema_type"),
                ),
                (
                    "participant_num",
                    models.ForeignKey(
